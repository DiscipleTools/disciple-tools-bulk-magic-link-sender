...
class Disciple_Tools_Magic_Links {
    ...
    private function __construct() {
         ...
         */
        if ( $is_rest && strpos( dt_get_url_path(), 'disciple_tools_magic_links_template' ) !== false ) {
...
if ( ! function_exists( 'disciple_tools_magic_links_hook_admin_notice' ) ) {
    function disciple_tools_magic_links_hook_admin_notice() {
        ...
        if ( ! get_option( 'dismissed-disciple-tools-magic-links', false ) ) { ?>
            <div class="notice notice-error notice-disciple-tools-magic-links is-dismissible" data-notice="disciple-tools-magic-links">
