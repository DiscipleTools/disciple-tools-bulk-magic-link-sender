...
class Disciple_Tools_Magic_Links_Site_Links {
    public $type = 'disciple_tools_magic_links';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'Magic Links' );
        return $type;
    }
}
Disciple_Tools_Magic_Links_Site_Links::instance();
