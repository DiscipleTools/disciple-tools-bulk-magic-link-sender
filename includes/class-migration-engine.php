 ...
 */
class Disciple_Tools_Bulk_Magic_Link_Migration_Engine {
     ...
     *
     * @throws \Exception ...
     * @throws \Disciple_Tools_Bulk_Magic_Link_Migration_Lock_Exception ...
     * @throws \Throwable ...
     */
    public static function migrate( int $target_migration_number ) {
        ...
        while ( true ) {
            $current_migration_number = get_option( Disciple_Tools_Bulk_Magic_Link_Sender_API::$option_dt_magic_links_migration_number );
            ...
            if ( (int) get_option( Disciple_Tools_Bulk_Magic_Link_Sender_API::$option_dt_magic_links_migration_lock, 0 ) ) {
                throw new Disciple_Tools_Bulk_Magic_Link_Migration_Lock_Exception();
            }
    ...
    public static function get_current_db_migration() {
        return get_option( Disciple_Tools_Bulk_Magic_Link_Sender_API::$option_dt_magic_links_migration_number, 0 );
    }
}
