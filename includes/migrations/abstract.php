 ...
 *      }
 *
 *  See the documentation for Disciple_Tools_Bulk_Magic_Link_Migration_Engine.
 *
 */
abstract class Disciple_Tools_Bulk_Magic_Link_Migration {
    ...
    /**
     * @throws \Disciple_Tools_Bulk_Magic_Link_Migration_Test_Exception Table $name not as expected, see error log.
     */
    protected function test_expected_tables() {
        ...
        foreach ( $expected_tables as $name => $expected_table ) {
            ...
            if ( $got_table !== $expected_table ) {
                ...
                //throw new Disciple_Tools_Bulk_Magic_Link_Migration_Test_Exception( "Table $name not as expected, see error log" );
            }
        }
    }
...
/**
 * Class Disciple_Tools_Bulk_Magic_Link_Migration_Test_Exception
 */
class Disciple_Tools_Bulk_Magic_Link_Migration_Test_Exception extends Exception {
}
